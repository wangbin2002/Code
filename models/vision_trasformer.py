...
data_cfg = dict(
    ...
    train = dict(
        ...
        pretrained_weights = 'datas/vit-base-p16_3rdparty_pt-64xb64_in1k-224_20210928-02284250.pth',
        freeze_flag = False,
        freeze_layers = ('backbone',),
        epoches = 100,
    ),
    test=dict(
        ckpt = 'logs/VisionTransformer/2025-05-13-17-51-17/Train_Epoch095-Loss0.410.pth',
